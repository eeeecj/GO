...
func (x *StringMessage) Reset() {
	*x = StringMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rest_rest_proto_msgTypes[0]
...
func (*StringMessage) Descriptor() ([]byte, []int) {
	return file_rest_rest_proto_rawDescGZIP(), []int{0}
}
...
var File_rest_rest_proto protoreflect.FileDescriptor

var file_rest_rest_proto_rawDesc = []byte{
	0x0a, 0x0f, 0x72, 0x65, 0x73, 0x74, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	,
}

var (
	file_rest_rest_proto_rawDescOnce sync.Once
	file_rest_rest_proto_rawDescData = file_rest_rest_proto_rawDesc
)

func file_rest_rest_proto_rawDescGZIP() []byte {
	file_rest_rest_proto_rawDescOnce.Do(func() {
		file_rest_rest_proto_rawDescData = protoimpl.X.CompressGZIP(file_rest_rest_proto_rawDescData)
	})
	return file_rest_rest_proto_rawDescData
}

var file_rest_rest_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_rest_rest_proto_goTypes = []interface{}{
	(*StringMessage)(nil), // 0: main.StringMessage
}
var file_rest_rest_proto_depIdxs = []int32{
...
func init() { file_rest_rest_proto_init() }
func file_rest_rest_proto_init() {
	if File_rest_rest_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_rest_rest_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_rest_rest_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_rest_rest_proto_goTypes,
		DependencyIndexes: file_rest_rest_proto_depIdxs,
		MessageInfos:      file_rest_rest_proto_msgTypes,
	}.Build()
	File_rest_rest_proto = out.File
	file_rest_rest_proto_rawDesc = nil
	file_rest_rest_proto_goTypes = nil
	file_rest_rest_proto_depIdxs = nil
}
