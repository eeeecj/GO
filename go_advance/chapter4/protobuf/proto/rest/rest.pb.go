...
func (x *StringMessage) Reset() {
	*x = StringMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_rest_rest_proto_msgTypes[0]
...
func (*StringMessage) Descriptor() ([]byte, []int) {
	return file_proto_rest_rest_proto_rawDescGZIP(), []int{0}
}
...
var File_proto_rest_rest_proto protoreflect.FileDescriptor

var file_proto_rest_rest_proto_rawDesc = []byte{
	0x0a, 0x15, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x2f, 0x72, 0x65, 0x73,
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x6d, 0x61, 0x69, 0x6e, 0x1a, 0x1c, 0x67,
	...
	0x75, 0x65, 0x32, 0x98, 0x01, 0x0a, 0x0b, 0x52, 0x65, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x45, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x13, 0x2e, 0x6d, 0x61, 0x69, 0x6e,
	...
	0x74, 0x2f, 0x7b, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x7d, 0x12, 0x42, 0x0a, 0x04, 0x50, 0x6f, 0x73,
	0x74, 0x12, 0x13, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x13, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x10, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x0a, 0x22, 0x05, 0x2f, 0x70, 0x6f, 0x73, 0x74, 0x3a, 0x01, 0x2a, 0x42, 0x09, 0x5a,
	0x07, 0x2e, 0x2f, 0x3b, 0x72, 0x65, 0x73, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_proto_rest_rest_proto_rawDescOnce sync.Once
	file_proto_rest_rest_proto_rawDescData = file_proto_rest_rest_proto_rawDesc
)

func file_proto_rest_rest_proto_rawDescGZIP() []byte {
	file_proto_rest_rest_proto_rawDescOnce.Do(func() {
		file_proto_rest_rest_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_rest_rest_proto_rawDescData)
	})
	return file_proto_rest_rest_proto_rawDescData
}

var file_proto_rest_rest_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_rest_rest_proto_goTypes = []interface{}{
	(*StringMessage)(nil), // 0: main.StringMessage
}
var file_proto_rest_rest_proto_depIdxs = []int32{
...
func init() { file_proto_rest_rest_proto_init() }
func file_proto_rest_rest_proto_init() {
	if File_proto_rest_rest_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_rest_rest_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_rest_rest_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_rest_rest_proto_goTypes,
		DependencyIndexes: file_proto_rest_rest_proto_depIdxs,
		MessageInfos:      file_proto_rest_rest_proto_msgTypes,
	}.Build()
	File_proto_rest_rest_proto = out.File
	file_proto_rest_rest_proto_rawDesc = nil
	file_proto_rest_rest_proto_goTypes = nil
	file_proto_rest_rest_proto_depIdxs = nil
}
...
var _RestService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/rest/rest.proto",
}
